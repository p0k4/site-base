...
async def run_test():
    ...
    try:
        ...
        try:
            ...
            raise AssertionError("Test case failed: The registration process did not complete successfully — after submitting valid user data the page did not show a 'Conta criada com sucesso' confirmation or redirect/prompt to login.")
